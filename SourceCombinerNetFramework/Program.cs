...
namespace SourceCombinerNetFramework
{
    internal class Program
    {
        ...
        private static string GenerateCombinedSource(List<string> namespaces, List<string> files)
        {
            ...
            sb.AppendLine(@"/*");
            sb.AppendLine($" * File generated by SourceCombinerNetFramework.exe using {files.Count} source files.");
            ...
            foreach (var file in files)
            {
                ...
                sb.AppendLine(@"//*** SourceCombinerNetFramework -> original file " + Path.GetFileName(file) + " ***");
